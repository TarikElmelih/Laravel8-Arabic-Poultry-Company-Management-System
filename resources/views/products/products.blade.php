                ...
                <div class="modal-content">
                    ...
                    <form action="{{ route('products.store') }}" method="post">
                        ...
                        <div class="modal-body">
                            ...
                            <label class="my-1 mr-2" for="inlineFormCustomSelectPref">الكمية</label>
                            ...
                            <select name="depot" class="form-control" id="depot">
                                <option value="الرصيد الافتتاحي">الرصيد الافتتاحي</option>
...
@section('js')
    ...
    <script>
        $('#edit_Product').on('show.bs.modal', function(event) {
            ...
            var product_amount	 = button.data('product_amount')
            var depot = button.data('depot')
            ...
            modal.find('.modal-body #product_amount	').val(product_amount	);
            modal.find('.modal-body #depot').val(depot);
        })
