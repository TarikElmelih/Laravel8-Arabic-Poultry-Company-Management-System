        ...
        <ul class="side-menu">
            ...
            <li class="slide">
                ...
                <ul class="slide-menu">
                       ...
                       <!-- <li><a class="slide-item" href="{{ url('/' . ($page = 'mixtures')) }}">الخلطات</a></li> -->

                        <li><a class="slide-item" href="{{ url('/' . ($page = 'outgoings')) }}">الصادر </a></li>

                        <li><a class="slide-item" href="{{ url('/' . ($page = 'incomings')) }}">الوارد </a></li>

                        <li><a class="slide-item" href="{{ url('/' . ($page = 'productions')) }}">الانتاج</a></li>

                        <li><a class="slide-item" href="{{ url('/' . ($page = 'Manufacturings')) }}">التصنيع </a></li>

                        <li><a class="slide-item" href="{{ url('/' . ($page = 'sells')) }}">المبيعات </a></li>

                        <li><a class="slide-item" href="{{ url('/' . ($page = 'Expenses')) }}">المصاريف </a></li>
            ...
            @can('التقارير')
                <li class="side-item side-item-category">فلترة التقارير</li>
                <li class="slide">
                    <a class="side-menu__item" data-toggle="slide" href="{{ url('/' . ($page = '#')) }}"><svg
                            xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
                            <path d="M0 0h24v24H0V0z" fill="none" />
                        ...
                        </svg><span class="side-menu__label">فلترة التقارير</span><i class="angle fe fe-chevron-down"></i></a>
                    <ul class="slide-menu">


                            <li><a class="slide-item" href="{{ url('/' . ($page = 'customers_report')) }}">الصادر </a></li>

                            <li><a class="slide-item" href="{{ url('/' . ($page = 'incoming_report')) }}">الوارد </a></li>

                            <li><a class="slide-item" href="{{ url('/' . ($page = 'production_report')) }}">الانتاج </a></li>

                            <li><a class="slide-item" href="{{ url('/' . ($page = 'manufacturing_report')) }}">التصنيع </a></li>

                            <li><a class="slide-item" href="{{ url('/' . ($page = 'sells_report')) }}">المبيعات </a></li>

                            <li><a class="slide-item" href="{{ url('/' . ($page = 'Expense_report')) }}">المصاريف </a></li>
            ...
            @can('الاعدادات')
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        @can('الاقسام')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'sections')) }}">المستخدمين</a></li>
                        @endcan
                            ...
                            @endcan
                            @can('المنتجات')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'addproduction')) }}">منتجات الانتاج</a></li>
                            @endcan

                            <li><a class="slide-item" href="{{ url('/' . ($page = 'mixes')) }}">دليل الخلطات</a></li>

                            <li><a class="slide-item" href="{{ url('/' . ($page = 'report')) }}">التقرير الشهري </a></li>
